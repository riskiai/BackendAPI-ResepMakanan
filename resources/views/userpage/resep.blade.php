        ...
        <div class="container">
            ...
            <div class="row pt-5">
                <div class="col-lg-8 col-12 order-2 order-lg-0 ">
                        ...
                        <img src="{{ asset('storage/photo-resep/' . $latestResep->image) }}" alt="gambar-{{$latestResep->judul}}" class="w-100 object-fit-cover" style="height: 500px">
            ...
            <div class="row mt-5 mb-5">
                ...
                <div class="d-flex flex-column flex-md-row align-items-center card-artikel p-3 mb-3 position-relative">
                    <div class="col-12 col-md-4">
                        ...
                        <img src="{{ asset('storage/photo-resep/' . $item->image) }}" alt="gambar-{{$item->judul}}" class="w-100 object-fit-cover" style="height: 250px">
                    </div>
