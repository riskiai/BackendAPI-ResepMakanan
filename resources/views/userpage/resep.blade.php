        ...
        <div class="container">
            ...
            <div class="row pt-5">
                <div class="col-lg-8 col-12 order-2 order-lg-0 ">
                    ...
                    <p class="p-0">ini adalah resep khas mamang nizar nasi goreng ini beda dari nasi goreng yang biasa kita buat nasi goreng ini hanya menggunakan bahan...</p>
                </div>
