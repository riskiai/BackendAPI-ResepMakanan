...
<main>
    <section id="register" class="pt-5 pb-5 mt-5">
        <div class="container">
            <div class="row">
                    ...
                    <div class="form-register">
                        ...
                        <form action="">
                            ...
                            <div class="d-flex mt-3 justify-content-between">
                                <a class="text-decoration-none text-black" href="#">Sudah punya akun ?</a>
                                <a href="#" class="btn-register text-decoration-none">Daftar</a>
                            </div>
                        </form>
                    </div>
                </div>
